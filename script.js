...
onChildAdded(messagesRef, (data) => {
  ...
  msgDiv.innerHTML = `
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; font-size: 10px; color: #888; border-top: 1px solid rgba(0,0,0,0.05); padding-top: 4px; font-family: inherit;">
